...
import general_ocr
from general_ocr.utils import ProgressBar
from general_ocr.apis import init_detector

from general_ocr.apis import model_inference
from general_ocr.core.evaluation.ocr_metric import eval_ocr_metric
from general_ocr.datasets import build_dataset  # noqa: F401
from general_ocr.models import build_detector  # noqa: F401
from general_ocr.utils import get_root_logger, list_from_file, list_to_file
...
def main():
    ...
    general_ocr.mkdir_or_exist(out_vis_dir)
    correct_vis_dir = osp.join(args.out_dir, 'correct')
    general_ocr.mkdir_or_exist(correct_vis_dir)
    wrong_vis_dir = osp.join(args.out_dir, 'wrong')
    general_ocr.mkdir_or_exist(wrong_vis_dir)
