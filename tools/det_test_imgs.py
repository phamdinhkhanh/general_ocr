...
from general_ocr.apis import inference_detector, init_detector

from general_ocr.models import build_detector  # noqa: F401
from general_ocr.utils import list_from_file, list_to_file
...
def main():
    ...
    general_ocr.mkdir_or_exist(out_txt_dir)
