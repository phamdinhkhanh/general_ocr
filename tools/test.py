...
import general_ocr
import torch
from general_ocr import Config, DictAction
from general_ocr.cnn import fuse_conv_bn
from general_ocr.image import tensor2imgs
from general_ocr.parallel import MMDataParallel, MMDistributedDataParallel
from general_ocr.runner import (get_dist_info, init_dist, load_checkpoint,
                         wrap_fp16_model)
from general_ocr.apis import multi_gpu_test
from general_ocr.core import encode_mask_results
from general_ocr.datasets import replace_ImageToTensor

from general_ocr.apis.inference import disable_text_recog_aug_test
from general_ocr.datasets import build_dataloader, build_dataset
from general_ocr.models import build_detector
from general_ocr.utils import revert_sync_batchnorm


def parse_args():
    parser = argparse.ArgumentParser(
        description='general_ocr test (and eval) a model.')
...
def single_gpu_test(model,
    ...
    prog_bar = general_ocr.ProgressBar(len(dataset))
        ...
        if show or out_dir:
            if is_kie:
                ...
                for i, (img, img_meta) in enumerate(zip(imgs, img_metas)):
                    ...
                    img_show = general_ocr.imresize(img_show, (ori_w, ori_h))
...
def main():
    ...
    if cfg.get('custom_imports', None):
        from general_ocr.utils import import_modules_from_strings
    ...
    if rank == 0:
        if args.out:
            ...
            general_ocr.dump(outputs, args.out)
