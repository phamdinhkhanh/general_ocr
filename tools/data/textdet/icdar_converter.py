...
from general_ocr.utils import convert_annotations, list_from_file
...
def collect_annotations(files, dataset, nproc=1):
    ...
    if nproc > 1:
        ...
        images = general_ocr.track_progress(load_img_info_with_dataset, files)
...
def main():
    ...
    for split, json_name in set_name.items():
        ...
        with general_ocr.Timer(print_tmpl='It takes {}s to convert icdar annotation'):
            files = collect_files(
