...
from general_ocr.utils.fileio import list_to_file
...
def collect_annotations(files, nproc=1):
    ...
    if nproc > 1:
        images = general_ocr.track_parallel_progress(
            load_img_info, files, nproc=nproc)
    else:
        images = general_ocr.track_progress(load_img_info, files)
...
def generate_ann(root_path, split, image_infos):
    ...
    for image_info in image_infos:
        ...
        image = general_ocr.imread(src_img_path)
        ...
        for anno in image_info['anno_info']:
            ...
            general_ocr.imwrite(dst_img, dst_img_path)
...
def main():
    ...
    general_ocr.mkdir_or_exist(out_dir)
