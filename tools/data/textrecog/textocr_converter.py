...
def process_img(args, src_image_root, dst_image_root):
    ...
    src_img = general_ocr.imread(osp.join(src_image_root, img_info['file_name']))
    labels = []
...
def convert_textocr(root_path,
    ...
    annotation = general_ocr.load(annotation_path)
    ...
    labels_list = general_ocr.track_parallel_progress(
