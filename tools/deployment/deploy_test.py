...
from general_ocr.runner import get_dist_info
from general_ocr.apis import single_gpu_test
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='general_ocr test (and eval) a onnx or tensorrt model.')
