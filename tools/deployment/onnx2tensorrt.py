...
import numpy as np
import torch
from general_ocr.parallel import collate
from general_ocr.tensorrt import is_tensorrt_plugin_loaded, onnx2trt, save_trt_engine
from general_ocr.datasets import replace_ImageToTensor
from general_ocr.datasets.pipelines import Compose

from general_ocr.core.deployment import (ONNXRuntimeDetector, ONNXRuntimeRecognizer,
                                   TensorRTDetector, TensorRTRecognizer)
from general_ocr.datasets.pipelines.crop import crop_img  # noqa: F401
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Convert general_ocr models from ONNX to TensorRT')
...
if __name__ == '__main__':
    ...
    cfg = general_ocr.Config.fromfile(args.model_config)
