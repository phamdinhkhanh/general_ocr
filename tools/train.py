...
from general_ocr.runner import get_dist_info, init_dist, set_random_seed
from general_ocr.utils import get_git_hash

from general_ocr import __version__
from general_ocr.apis import train_detector
from general_ocr.datasets import build_dataset
from general_ocr.models import build_detector
from general_ocr.utils import collect_env, get_root_logger
...
def main():
    ...
    # create work_dir
    general_ocr.mkdir_or_exist(osp.abspath(cfg.work_dir))
    # dump config
    ...
    if cfg.checkpoint_config is not None:
        # save general_ocr version, config file content and class names in
        # checkpoints as meta data
        cfg.checkpoint_config.meta = dict(
            general_ocr_version=__version__ + get_git_hash()[:7],
