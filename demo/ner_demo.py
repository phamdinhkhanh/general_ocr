...
from general_ocr.apis.inference import text_model_inference

from general_ocr.datasets import build_dataset  # NOQA
from general_ocr.models import build_detector  # NOQA
