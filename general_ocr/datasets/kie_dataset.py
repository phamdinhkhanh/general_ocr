...
import numpy as np
import torch
from general_ocr.datasets.builder import DATASETS

from general_ocr.core import compute_f1_score
from general_ocr.datasets.base_dataset import BaseDataset
from general_ocr.datasets.pipelines import sort_vertex8
from general_ocr.utils import is_type_list, list_from_file
