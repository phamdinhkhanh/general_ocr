...
class CocoPanopticDataset(CocoDataset):
    ...
    def _pan2json(self, results, outfile_prefix):
        ...
        for idx in range(len(self)):
            ...
            general_ocr.imwrite(pan[:, :, ::-1], os.path.join(outdir, segm_file))
            record = {
                'image_id': img_id,
    ...
    def results2json(self, results, outfile_prefix):
        ...
        general_ocr.dump(pan_json_results, result_files['panoptic'])
    ...
    def evaluate_pan_json(self,
        ...
        pred_json = general_ocr.load(result_files['panoptic'])
        pred_json = dict(
