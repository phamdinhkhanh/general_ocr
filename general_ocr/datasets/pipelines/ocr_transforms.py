...
from general_ocr.runner.dist_utils import get_dist_info
...
from general_ocr.datasets.pipelines.crop import warp_img
...
class RandomPaddingOCR:
    ...
    def __call__(self, results):
        ...
        img = general_ocr.impad(results['img'], padding=padding, padding_mode='edge')
