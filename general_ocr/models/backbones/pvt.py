...
from general_ocr.cnn import (Conv2d, build_activation_layer, build_norm_layer,
                      constant_init, normal_init, trunc_normal_init)
from general_ocr.cnn.bricks.drop import build_dropout
from general_ocr.cnn.bricks.transformer import MultiheadAttention
from general_ocr.runner import (BaseModule, ModuleList, Sequential, _load_checkpoint,
                         load_state_dict)
...
class SpatialReductionAttention(MultiheadAttention):
    ...
    general_ocr.cnn.bricks.transformer.
