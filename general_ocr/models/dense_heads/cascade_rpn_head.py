...
from general_ocr import ConfigDict
from general_ocr.ops import DeformConv2d, batched_nms
from general_ocr.runner import BaseModule, ModuleList

from general_ocr.core import (RegionAssigner, build_assigner, build_sampler,
