...
from general_ocr.cnn import ConvModule, bias_init_with_prob
from general_ocr.ops import CornerPool, batched_nms
...
class CornerHead(BaseDenseHead, BBoxTestMixin):
    ...
    def decode_heatmap(self,
        ...
        if not torch.onnx.is_in_onnx_export():
            ...
            # `general_ocr/core/export/model_wrappers.py`. Though difference between
