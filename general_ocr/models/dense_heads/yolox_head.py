...
from general_ocr.cnn import (ConvModule, DepthwiseSeparableConvModule,
                      bias_init_with_prob)
from general_ocr.ops.nms import batched_nms
from general_ocr.runner import force_fp32

from general_ocr.core import (MlvlPointGenerator, bbox_xyxy_to_cxcywh,
...
class YOLOXHead(BaseDenseHead, BBoxTestMixin):
    ...
    def get_bboxes(self,
        ...
        Args:
            ...
            cfg (general_ocr.Config, Optional): Test / postprocessing configuration,
