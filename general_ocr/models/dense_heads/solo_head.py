...
from general_ocr.core import InstanceData, mask_matrix_nms, multi_apply
from general_ocr.core.utils import center_of_mass, generate_coordinate
    ...
    def _get_targets_single(self,
        ...
        for (lower_bound, upper_bound), stride, featmap_size, num_grid \
            ...
            for gt_mask, gt_label, pos_h_range, pos_w_range, \
                ...
                gt_mask = general_ocr.imrescale(gt_mask, scale=1. / output_stride)
