...
from general_ocr.cnn import ConvModule
from general_ocr.ops import batched_nms
...
class RPNHead(AnchorHead):
    ...
    def _get_bboxes_single(self,
        ...
        for idx in range(len(cls_scores)):
            ...
            if self.use_sigmoid_cls:
                ...
                # num_class in RPN head since general_ocr v2.5, which is unified to
                # be consistent with other head since general_ocr v2.0. In general_ocr v2.0
    ...
    def onnx_export(self, x, img_metas):
        ...
        for idx in range(len(cls_scores)):
            ...
            from general_ocr.core.export import get_k_for_topk
        ...
        from general_ocr.core.export import add_dummy_nms_for_onnx
