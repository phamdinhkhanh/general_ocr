...
from general_ocr.cnn import Conv2d, Linear, build_activation_layer
from general_ocr.cnn.bricks.transformer import FFN, build_positional_encoding
from general_ocr.runner import force_fp32

from general_ocr.core import (bbox_cxcywh_to_xyxy, bbox_xyxy_to_cxcywh,
                        build_assigner, build_sampler, multi_apply,
                        reduce_mean)
from general_ocr.models.utils import build_transformer
...
class DETRHead(AnchorFreeHead):
    ...
    Args:
        ...
        transformer (obj:`general_ocr.ConfigDict`|dict): Config for transformer.
            Default: None.
        sync_cls_avg_factor (bool): Whether to sync the avg_factor of
            all ranks. Default to False.
        positional_encoding (obj:`general_ocr.ConfigDict`|dict):
            Config for position encoding.
        loss_cls (obj:`general_ocr.ConfigDict`|dict): Config of the
            classification loss. Default `CrossEntropyLoss`.
        loss_bbox (obj:`general_ocr.ConfigDict`|dict): Config of the
            regression loss. Default `L1Loss`.
        loss_iou (obj:`general_ocr.ConfigDict`|dict): Config of the
            regression iou loss. Default `GIoULoss`.
        tran_cfg (obj:`general_ocr.ConfigDict`|dict): Training config of
            transformer head.
        test_cfg (obj:`general_ocr.ConfigDict`|dict): Testing config of
            transformer head.
    ...
    def forward_train(self,
        ...
        Args:
            ...
            proposal_cfg (general_ocr.Config): Test / postprocessing configuration,
    ...
    def onnx_export(self, all_cls_scores_list, all_bbox_preds_list, img_metas):
        ...
        from general_ocr.core.export import dynamic_clip_for_onnx
