...
from general_ocr.cnn import ConvModule, Scale
from general_ocr.ops import DeformConv2d
from general_ocr.runner import force_fp32

from general_ocr.core import (bbox2distance, bbox_overlaps, build_anchor_generator,
...
class VFNetHead(ATSSHead, FCOSHead):
    ...
    def forward_single(self, x, scale, scale_refine, stride, reg_denom):
        ...
        Args:
            ...
            scale (:obj: `general_ocr.cnn.Scale`): Learnable scale module to resize
                the bbox prediction.
            scale_refine (:obj: `general_ocr.cnn.Scale`): Learnable scale module to
    ...
    def get_bboxes(self,
        ...
        Args:
            ...
            img_metas (list[dict]): Meta information of each image, e.g.,
                image size, scaling factor, etc.
            cfg (general_ocr.Config): Test / postprocessing configuration,
    ...
    def _get_bboxes_single(self,
        ...
        Args:
            ...
            cfg (general_ocr.Config | None): Test / postprocessing configuration,
        ...
        # remind that we set FG labels to [0, num_class-1] since general_ocr v2.0
        # BG cat_id: num_class
