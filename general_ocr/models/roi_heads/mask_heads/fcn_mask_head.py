...
from general_ocr.cnn import ConvModule, build_conv_layer, build_upsample_layer
from general_ocr.ops.carafe import CARAFEPack
from general_ocr.runner import BaseModule, ModuleList, auto_fp16, force_fp32
from torch.nn.modules.utils import _pair

from general_ocr.core import mask_target
...
class FCNMaskHead(BaseModule):
    ...
    def loss(self, mask_pred, mask_targets, labels):
        """
        Example:
            >>> from general_ocr.models.roi_heads.mask_heads.fcn_mask_head import *  # NOQA
    ...
    def get_seg_masks(self, mask_pred, det_bboxes, det_labels, rcnn_test_cfg,
        ...
        Example:
            ...
            >>> rcnn_test_cfg = general_ocr.Config({'mask_thr_binary': 0, })
            >>> ori_shape = (H * 4, W * 4)
