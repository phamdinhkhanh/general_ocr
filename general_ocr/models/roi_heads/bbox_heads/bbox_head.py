...
from general_ocr.runner import BaseModule, auto_fp16, force_fp32
from torch.nn.modules.utils import _pair

from general_ocr.core import build_bbox_coder, multi_apply, multiclass_nms
from general_ocr.models.builder import HEADS, build_loss
from general_ocr.models.losses import accuracy
from general_ocr.models.utils import build_linear_layer
...
class BBoxHead(BaseModule):
    ...
    def refine_bboxes(self, rois, labels, bbox_preds, pos_is_gts, img_metas):
        ...
        Example:
            ...
            >>> import kwarray
            >>> import numpy as np
            >>> from general_ocr.core.bbox.demodata import random_boxes
