...
from general_ocr.core import (bbox2result, bbox2roi, bbox_mapping, merge_aug_bboxes,
                        multiclass_nms)
from general_ocr.models.roi_heads.standard_roi_head import StandardRoIHead
