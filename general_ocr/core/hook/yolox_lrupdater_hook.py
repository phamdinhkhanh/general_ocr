...
from general_ocr.runner.hooks import HOOKS
from general_ocr.runner.hooks.lr_updater import (CosineAnnealingLrUpdaterHook,
                                          annealing_cos)
...
class YOLOXLrUpdaterHook(CosineAnnealingLrUpdaterHook):
    ...
    and CosineAnnealingLrUpdaterHook.
       ...
       2. The exp warmup scheme is different with LrUpdaterHook in general_ocr
