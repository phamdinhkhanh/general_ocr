...
from general_ocr.core.evaluation import hmean_ic13, hmean_iou
from general_ocr.core.evaluation.utils import (filter_2dlist_result,
                                         select_top_boundary)
from general_ocr.core.mask_ import extract_boundary
...
def output_ranklist(img_results, img_infos, out_file):
    ...
    general_ocr.dump(sorted_results, file=out_file)
