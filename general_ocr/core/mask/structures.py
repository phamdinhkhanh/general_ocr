...
import torch
from general_ocr.ops.roi_align import roi_align
...
class BaseInstanceMasks(metaclass=ABCMeta):
    ...
    def rescale(self, scale, interpolation='nearest'):
        ...
        For details can refer to `general_ocr.imrescale`.

        Args:
            scale (tuple[int]): The maximum size (h, w) of rescaled mask.
            interpolation (str): Same as :func:`general_ocr.imrescale`.
    ...
    def resize(self, out_shape, interpolation='nearest'):
        ...
        Args:
            ...
            interpolation (str): See :func:`general_ocr.imresize`.
    ...
    def crop_and_resize(self,
        ...
        Args:
            ...
            interpolation (str): See `general_ocr.imresize`
    ...
    def translate(self,
        ...
        Args:
            ...
            interpolation (str): Same as :func:`general_ocr.imtranslate`.
    ...
    def shear(self,
        ...
        Args:
            ...
            interpolation (str): Same as in :func:`general_ocr.imshear`.
...
class BitmapMasks(BaseInstanceMasks):
    ...
    def rescale(self, scale, interpolation='nearest'):
        ...
        if len(self.masks) == 0:
            new_w, new_h = general_ocr.rescale_size((self.width, self.height), scale)
            rescaled_masks = np.empty((0, new_h, new_w), dtype=np.uint8)
        else:
            rescaled_masks = np.stack([
                general_ocr.imrescale(mask, scale, interpolation=interpolation)
    ...
    def flip(self, flip_direction='horizontal'):
        ...
        if len(self.masks) == 0:
            ...
            flipped_masks = np.stack([
                general_ocr.imflip(mask, direction=flip_direction)
                for mask in self.masks
            ])
    ...
    def pad(self, out_shape, pad_val=0):
        ...
        if len(self.masks) == 0:
            ...
            padded_masks = np.stack([
                general_ocr.impad(mask, shape=out_shape, pad_val=pad_val)
                for mask in self.masks
            ])
    ...
    def translate(self,
        ...
        if len(self.masks) == 0:
            ...
            translated_masks = general_ocr.imtranslate(
    ...
    def shear(self,
        ...
        if len(self.masks) == 0:
            ...
            sheared_masks = general_ocr.imshear(
                self.masks.transpose((1, 2, 0)),
                magnitude,
                direction,
    ...
    def rotate(self, out_shape, angle, center=None, scale=1.0, fill_val=0):
        ...
        if len(self.masks) == 0:
            ...
            rotated_masks = general_ocr.imrotate(
                self.masks.transpose((1, 2, 0)),
                angle,
                center=center,
                scale=scale,
