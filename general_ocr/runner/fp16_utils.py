...
from general_ocr.utils import TORCH_VERSION, digit_version
from .dist_utils import allreduce_grads as _allreduce_grads

try:
    # If PyTorch version >= 1.6.0, torch.cuda.amp.autocast would be imported
    # and used; otherwise, auto fp16 will adopt general_ocr's implementation.
...
def force_fp32(apply_to=None, out_fp16=False):
    ...
    torch.cuda.amp is used as the backend, otherwise, original general_ocr
...
def allreduce_grads(params, coalesce=True, bucket_size_mb=-1):
    warnings.warning(
        '"general_ocr.runner.fp16_utils.allreduce_grads" is deprecated, and will be '
        'removed in v2.8. Please switch to "general_ocr.runner.allreduce_grads')
...
def wrap_fp16_model(model):
    ...
    backend, otherwise, original general_ocr implementation will be adopted.
