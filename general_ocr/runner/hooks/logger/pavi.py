    ...
    def before_run(self, runner):
        ...
        if runner.meta is not None:
            if 'config_dict' in runner.meta:
                ...
                config_dict = dict(general_ocr.utils.Config.fromfile(config_file))
            else:
                config_dict = None
            if config_dict is not None:
                ...
                # general_ocr.dump to json
                config_dict = json.loads(
                    fileio.dump(config_dict, file_format='json'))
