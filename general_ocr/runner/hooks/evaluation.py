...
from general_ocr.utils import is_seq_of
...
class EvalHook(Hook):
    ...
    Args:
        ...
        test_fn (callable, optional): test a model with samples from a
            ...
            test function ``general_ocr.engine.single_gpu_test`` will be used.
            (default: ``None``)
    ...
    def __init__(self,
        ...
        if test_fn is None:
            from general_ocr.engine import single_gpu_test
...
class DistEvalHook(EvalHook):
    ...
    Args:
        ...
        test_fn (callable, optional): test a model with samples from a
            ...
            ``None``, the default test function ``general_ocr.engine.multi_gpu_test``
            will be used. (default: ``None``)
    ...
    def __init__(self,
        ...
        if test_fn is None:
            from general_ocr.engine import multi_gpu_test
