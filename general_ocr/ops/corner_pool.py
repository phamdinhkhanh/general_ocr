...
class TopPoolFunction(Function):
    ...
    def symbolic(g, input):
        output = g.op(
            'general_ocr::general_ocrCornerPool', input, mode_i=int(_mode_dict['top']))
        return output
...
class BottomPoolFunction(Function):
    ...
    def symbolic(g, input):
        output = g.op(
            'general_ocr::general_ocrCornerPool', input, mode_i=int(_mode_dict['bottom']))
        return output
...
class LeftPoolFunction(Function):
    ...
    def symbolic(g, input):
        output = g.op(
            'general_ocr::general_ocrCornerPool', input, mode_i=int(_mode_dict['left']))
        return output
...
class RightPoolFunction(Function):
    ...
    def symbolic(g, input):
        output = g.op(
            'general_ocr::general_ocrCornerPool', input, mode_i=int(_mode_dict['right']))
        return output
