...
static const char *PLUGIN_NAME{"general_ocrRoiAlign"};
}  // namespace
...
size_t RoIAlignPluginDynamic::getWorkspaceSize(
  ...
  switch (mPoolMode) {
    case 0:  // max
      ...
      word_size = general_ocr::getElementSize(outputs[0].type);
...
int RoIAlignPluginDynamic::enqueue(const nvinfer1::PluginTensorDesc *inputDesc,
  ...
  int word_size = general_ocr::getElementSize(outputDesc[0].type);
