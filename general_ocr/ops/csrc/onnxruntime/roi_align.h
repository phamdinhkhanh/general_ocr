...
struct general_ocrRoiAlignKernel {
 public:
  general_ocrRoiAlignKernel(Ort::CustomOpApi ort, const OrtKernelInfo* info)
      : ort_(ort) {
...
struct general_ocrRoiAlignCustomOp
    : Ort::CustomOpBase<general_ocrRoiAlignCustomOp, general_ocrRoiAlignKernel> {
  void* CreateKernel(Ort::CustomOpApi api, const OrtKernelInfo* info) const {
    return new general_ocrRoiAlignKernel(api, info);
  }
  const char* GetName() const { return "general_ocrRoiAlign"; }
