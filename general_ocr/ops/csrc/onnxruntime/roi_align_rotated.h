...
struct general_ocrRoIAlignRotatedKernel {
 public:
  general_ocrRoIAlignRotatedKernel(Ort::CustomOpApi ort, const OrtKernelInfo* info)
      : ort_(ort) {
    aligned_height_ =
...
struct general_ocrRoIAlignRotatedCustomOp
    : Ort::CustomOpBase<general_ocrRoIAlignRotatedCustomOp,
                        general_ocrRoIAlignRotatedKernel> {
  void* CreateKernel(Ort::CustomOpApi api, const OrtKernelInfo* info) const {
    return new general_ocrRoIAlignRotatedKernel(api, info);
  }
  const char* GetName() const { return "general_ocrRoIAlignRotated"; }
